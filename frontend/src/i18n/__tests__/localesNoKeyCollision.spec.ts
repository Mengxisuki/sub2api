...
import enAdminTLSFingerprintProfiles from '../locales/en/admin/tlsFingerprintProfiles'
...
import zhAdminTLSFingerprintProfiles from '../locales/zh/admin/tlsFingerprintProfiles'
...
const admins: Record<string, Modules> = {
  zh: {
    ...
    tlsFingerprintProfiles: zhAdminTLSFingerprintProfiles
  },
  en: {
    ...
    tlsFingerprintProfiles: enAdminTLSFingerprintProfiles
  }
}
